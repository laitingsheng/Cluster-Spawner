...
kubectl label node --overwrite t-r-k8s-minion-large-{0..7} node-role.kubernetes.io/worker=worker
kubectl taint nodes t-r-k8s-minion-large-{0..7} only=workload:NoSchedule
